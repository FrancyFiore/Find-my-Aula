            ...
            var b,
                ...
                g = {
                    ...
                    reset: function() {
                        ...
                        /* AGGIUNTI PER RIPRISTINARE L'UTILIZZO DEI PULSANTI */
                        /*document.getElementById("OraPrecedente").disabled = false;
                        document.getElementById("Ora").disabled = false;
                        document.getElementById("ProssimaOra").disabled = false;*/
                        document.getElementById("OraPrecedente").style.display = 'inline';
                        document.getElementById("Ora").style.display = 'inline';
                        document.getElementById("ProssimaOra").style.display = 'inline';
                    }
                },
                h = function(b) {
                    /* AGGIUNTI PER TOGLIERE L'UTILIZZO DEI PULSANTI */
                    /*document.getElementById("OraPrecedente").disabled = true;
                    document.getElementById("Ora").disabled = true;
                    document.getElementById("ProssimaOra").disabled = true;*/
                    document.getElementById("OraPrecedente").style.display = 'none';
                    document.getElementById("Ora").style.display = 'none';
                    document.getElementById("ProssimaOra").style.display = 'none';
