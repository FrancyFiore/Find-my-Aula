        ...
        if (check.checked) { /* MOSTRO I COLORI IN CASO DI CHECKED DEL BOX */
            ...
            if(selectedLevel-1 == 0){
                for(var j=0; j<8; j++){
                    ...
                    j++;
                    classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="1.0' + j + '"]'), 'map__space--libera');
                    j--;
                    ...
                    j++;
                    classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="1.0' + j + '"]'), 'map__space--liberapoco');
                    j--;
                    ...
                    j++;
                    classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="1.0' + j + '"]'), 'map__space--occupata');
                    j--;
                        
                    }
                }
            }
            else if(selectedLevel-1 == 1){
                for(var j=0; j<24; j++){  
                    if(j<9){
                        if(Libere[1][j] == 0){ 

                        j++;
                        classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="2.0' + j + '"]'), 'map__space--libera');
                        j--;
                        ...
                        j++;
                        classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="2.0' + j + '"]'), 'map__space--liberapoco');
                        j--;
                        ...
                        j++;
                        classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="2.0' + j + '"]'), 'map__space--occupata');
                        j--;
                        ...
                        j++;
                        classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="2.' + j + '"]'), 'map__space--libera');
                        j--;
                        ...
                        j++;
                        classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="2.' + j + '"]'), 'map__space--liberapoco');
                        j--;
                        ...
                        j++;
                        classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__space[data-space="2.' + j + '"]'), 'map__space--occupata');
                        j--;
            ...
            if(selectedLevel-1 == 0){
                for(var j=0; j<8; j++){
                    var activeSpaceArea = mallLevels[selectedLevel - 1].querySelector('svg > .map__space--libera');
                    if( activeSpaceArea ) {
                        classie.remove(activeSpaceArea, 'map__space--libera');
                    }
                    var activeSpaceArea = mallLevels[selectedLevel - 1].querySelector('svg > .map__space--liberapoco');
                    if( activeSpaceArea ) {
                        classie.remove(activeSpaceArea, 'map__space--liberapoco');
                    }
                    var activeSpaceArea = mallLevels[selectedLevel - 1].querySelector('svg > .map__space--occupata');
                    if( activeSpaceArea ) {
